...
def parse_command_line_args():
    ...
    parser.add_argument('--mode', choices=['gui', 'rpa', 'both', 'streamlit', 'notepad'],
...
def main() -> None:
    ...
    try:
        ...
        while True:
            ...
            print("7️⃣ 📝 Notepad++ otomasyon demosu")
            print("0️⃣ ❌ Çıkış")
            print("="*70)

            try:
                choice = input("🎯 Seçiminiz (0-7): ").strip()
